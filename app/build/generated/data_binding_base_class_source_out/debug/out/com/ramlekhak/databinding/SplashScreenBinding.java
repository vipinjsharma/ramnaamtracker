...
public final class SplashScreenBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView appNameTransliterated;
  ...
  private SplashScreenBinding(@NonNull ConstraintLayout rootView, @NonNull TextView appName,
      @NonNull TextView appNameTransliterated, @NonNull ProgressBar loadingSpinner,
      @NonNull ImageView splashLogo) {
    this.rootView = rootView;
    this.appName = appName;
    this.appNameTransliterated = appNameTransliterated;
  ...
  public static SplashScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.app_name_transliterated;
      TextView appNameTransliterated = ViewBindings.findChildViewById(rootView, id);
      if (appNameTransliterated == null) {
        break missingId;
      }
      ...
      return new SplashScreenBinding((ConstraintLayout) rootView, appName, appNameTransliterated,
