...
public abstract class Hilt_WritingFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_WritingFragment() {
    super();
  }

  Hilt_WritingFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WritingFragment_GeneratedInjector) this.generatedComponent()).injectWritingFragment(UnsafeCasts.<WritingFragment>unsafeCast(this));
    }
  }
